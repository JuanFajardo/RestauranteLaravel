@extends('maestro')
@section('card-header') BIENES  @endsection
      ...
      <div class="modal-body panel-body">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            {!! Form::text('bien', null, ['class'=>'form-control letras', 'placeholder'=>'Bienes', 'id'=>'bien_', 'required']) !!}
          </div>
          <div class="col-md-6">
            <label for="id_unidad_" > <b><i>Unidad</i></b> </label>
            {!! Form::select('id_unidad', \App\Unidad::pluck('unidad', 'id'), null, ['class'=>'form-control', 'placeholder'=>'', 'id'=>'id_unidad_', 'required']) !!}
          </div>
        </div>
            ...
            <div class="modal-content panel panel-warning ">
                ...
                <div class="modal-body panel-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <label for="id_unidad_" > <b><i>Unidad</i></b> </label>
                        {!! Form::select('id_unidad', \App\Unidad::pluck('unidad', 'id'), null, ['class'=>'form-control', 'placeholder'=>'', 'id'=>'id_unidad', 'required']) !!}
                      </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><a href="#modalAgregar"   data-toggle="modal" class="nuevo" data-target=""> <li class="fa fa-plus"></li> Nuevo Bien</a> <br/> </div>
    ...
    jQuery.getJSON(link, function(data, textStatus) {
      if(data.length > 0){
        jQuery.each(data, function(index, el) {
          ...
          jQuery('#id_unidad').val(el.id_unidad);
        });
      }
            });
        });
